...
if (isset($_SESSION['SESSION_EMAIL'])) {
  ...
  die();
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT user_id, roles, code FROM users WHERE email='{$email}' AND password='{$password}'";
...
<div class="wrapper">
    ...
    <form action="student-login.php" method="post">
      ...
      <div class="text">
        <h3>Not yet registered? Register <a href="student-register.php">here</a></h3>
      </div>
    </form>
  </div>
