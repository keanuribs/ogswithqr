...
<html lang="en">
  <head>
    ...
    <title>DCS | Students Year and Section</title>
...
<!-- Yr Lvl Modal -->
<div class="modal fade" id="yrLvlDataModal" tabindex="-1" aria-labelledby="yrLvlAddEditModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="submitYrLvlBtn">Submit</button>
            </div>
            </form>
        </div>
    </div>
