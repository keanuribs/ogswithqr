...
<!-- Course Modal -->
<div class="modal fade" id="courseDataModal" tabindex="-1" aria-labelledby="courseAddEditModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="submitCourseBtn">Submit</button>
            </div>
            </form>
        </div>
    </div>
