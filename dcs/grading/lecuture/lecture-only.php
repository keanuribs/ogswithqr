...
<body>
    ...
    <script>
        function consolidation(){
            ...
            var totallectureweighted=totallecture;

            //finals
            var totalmidtermgrade=(eval(document.getElementById('attendanceWeighted').value)+eval(document.getElementById('participation-weighted').value)+eval(document.getElementById('quiz-weighted').value)+eval(document.getElementById('portfolio-weighted').value)+eval(document.getElementById('midterm-weighted').value)).toFixed(2);
            var totalfinalgrade=(totallectureweighted).toFixed(2);
